@extends("admin.admin")
 @section('content')
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href=""> Quản lý Tuyển dụng      ({{$data_list->total()}})  </a>
                </li>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <i class="fa fa-align-justify"></i>  Quản lý Tuyển dụng  ( {{$data_list->total()}} )
                                </div>
                                    ...
                                    <table class="table table-sm">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-sm btn-success" href='/admin/recuitment/edit/<?php echo $list['id'];?>'><i class="fa fa-edit"></i> Sửa </a>
                                                    <a class="btn btn-sm btn-danger click_remove" href='/admin/recuitment/remove?id=<?php echo $list['id'];?>&_token={{ csrf_token() }}'> <i class="fa fa-remove"></i> Xoá  </a>
                                                </td>
