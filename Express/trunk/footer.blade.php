        ...
        <footer id="footerWrap">
            <div id="footer">
                <div id="accessContent">
                    ...
                    <p class="accessText"> 有料職業紹介許可/厚生労働大臣許可　12 - ユ  301072 <br> 登録支援機関/法務省·出入国在留管理庁登録 20登-004711<br> 菓子製造業/群馬県指令太保 第006114-00000037号<br> 飲食店営業（一般）/群馬県指令太保 第006114-00000039号</p>
                    <p id="copyright">Copyright © M&R TRADING, all rights reserved </p>
                    <!-- /footerRight -->
                </div>
                <div id="footerList">
                    <ul id="footerList01">
