...
class CustomerController extends AppController
{
	...
	public function signin(){
		$this->View['active']="customer";
		$this->View['TSeo']['seo_title']=" Đăng ký ";
		return view("default.customer.signin",$this->View);
	}
	public function search(){
		$this->View['active']="customer";
		$this->View['TSeo']['seo_title']=" Tìm kiếm  ";
		return view("default.customer.search",$this->View);
	}
	...
	public function order(){
		$this->View['active']="order";
		$this->View['TSeo']['seo_title']=" Lịch sử đơn hàng ";
		$this->View['data']=Auth::user();
		return view("default.customer.order",$this->View);
	}
	public function created(){
		$this->View['active']="created";
		$this->View['TSeo']['seo_title']=" Tạo đơn hàng ";
		$this->View['data']=Auth::user();
		return view("default.customer.created",$this->View);
	}
