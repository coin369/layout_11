...
class NewsController extends AppController
{
    ...
    public function index(){
        ...
        $this->View['TNews']=DTNews::where("status","1")->orderBy("updated_at","DESC")->paginate(4);
    ...
    public function cate($alias){
    	...
    	if(!empty($cate)){
            ...
            $this->View['TNews']=DTNews::where("status",'1')->where("cid_cate",$cate['id'])->orderBy('id',"DESC")->paginate(9);
    ...
    public function detail($alias)
    {
        ...
        if(!empty($news)){
            ...
            $this->View['list']= DTNews::orderBy("id","DESC")->limit(6)->get();
             $this->View['alias_cate']=$cate['alias'];
