			...
			<div style="width: 746px; margin-top:18px;float: left;margin-left: 88px">
				...
				<div style="width: 100%;float: left;background: #fff;">
					<div style="width: 100%;height: 35px;float: left;padding-left: 18px;">
						<a href="#" style="font: bold 16pt Tahoma;color: #04439a;text-decoration: none;line-height: 41px;cursor: default">Xin chào: {{$Payment['name']}} </a>
					</div>
					...
					<div  style="margin-top: 10px;float: left;width: 100%;">
						<table style="width: 96%;margin-left: 10px;border: 1px solid #DDD; border-spacing: 0;">
							<tr style=" border-spacing: 0;background: #f9f9f9">   
								...
								<th style="font: bold 12pt Tahoma;color: #0349ab">Hình ảnh-Tên Thiết kế</th>
							...
							<tr style="vertical-align: inherit;text-align: center;">   
								...
								<td style="padding: 5px;">
									<img width="30%" height="100%" style="float: left;" src="http://{{$_SERVER['SERVER_NAME']}}/upload/product/small/{{$p['picture']}}" />
					...
					<div style="margin-top: 5px;margin-left: 10px;float: left;">
						<a style="font: normal 12pt Tahoma;color: #166a96"> </a>
					</div>
				</div>
				<div style="text-align: center;width: 100%;"><a style="font: normal 10pt Tahoma;color: #fff"> &#169; 2018. Nước hoa Đăng cấp. </a></div>
			</div>
