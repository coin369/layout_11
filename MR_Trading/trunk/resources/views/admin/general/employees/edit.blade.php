@extends("admin.admin")
 @section('content')
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="/admin/employees/lists"> Danh sách Nhân viên     </a>
                </li>
    ...
    <span style="color:red">*</span>
      ...
      {!! Form::file('picture',['class'=>'load_banner form-control is-invalid','accept'=>'image/*','id'=>'banner_name']) !!}
                                                ...
                                                <div class="detail_banner">
                                                    ...
                                                    <img class='img-thumbnail' src='/public/upload/employees/{{$data["picture"]}}' class="img-thumbnail" />
                                                </div>
                                                        </div>
