        ...
        <div class="ps-categogy">
            <section class="project-ask project-ask-news">
                <div class="container">
                    <div class="pro-ask-content">
                        <h2 data-aos="slide-in-left">Tin tức cập nhật</h2>
            ...
            <div class="container">
                <ul class="ps-breadcrumb">
                    ...
                    <li class="ps-breadcrumb__item"><a href="javascript:;" title="#"><b>Tin tức </b></a></li>
                </ul>
            </div>
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-9 col-md-12 box_frist">
                        <div class="row">
                            <div class="col-lg-12 col-md-12 box_top_cate box_top_cate_news">
                                <h1 class="ps-categogy__name">TIN TỨC SƠN CÔNG NGHIỆP</h1>
