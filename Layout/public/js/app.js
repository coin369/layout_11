...
window.$ = window.jQuery = __webpack_require__(/*! ../js/jquery-2.2.0.min */ "./assets/js/jquery-2.2.0.min.js");
__webpack_require__(/*! ../js/jquery.scrollUp.js */ "./assets/js/jquery.scrollUp.js");
__webpack_require__(/*! ../js/common.js */ "./assets/js/common.js");
window.WOW = __webpack_require__(/*! ../js/wow.js */ "./assets/js/wow.js");
__webpack_require__(/*! ../js/jquery.bxslider.min.js */ "./assets/js/jquery.bxslider.min.js");
__webpack_require__(/*! ../js/feed.js */ "./assets/js/feed.js");
  ...
  setInit: function setInit() {
    ...
    $("img.over[src!='_on.']").each(function () {
      ...
      if (check_o != "_on") {
        ...
        $(this).hover(function () {
          this.src = rollover.p[o].src;
        }, function () {
          this.src = rollover.p[n].src;
        });
      }
    });
  }
    ...
    var s = X(window).width(),
      ...
      o = function o() {
        d.settings = X.extend({}, V, e), d.settings.slideWidth = parseInt(d.settings.slideWidth), d.children = c.children(d.settings.slideSelector), d.children.length < d.settings.minSlides && (d.settings.minSlides = d.children.length), d.children.length < d.settings.maxSlides && (d.settings.maxSlides = d.children.length), d.settings.randomStart && (d.settings.startSlide = Math.floor(Math.random() * d.children.length)), d.active = {
          ...
          for (var i in e) if (void 0 !== t.style[e[i]]) return d.cssPrefix = e[i].replace("Perspective", "").toLowerCase(), d.animProp = "-" + d.cssPrefix + "-transform", !0;
          return !1;
      ...
      t = function t() {
        ...
        d.viewport.css({
          ...
          listStyle: "none",
          position: "relative"
        }), d.children.css("width", h()), "horizontal" == d.settings.mode && 0 < d.settings.slideMargin && d.children.css("marginRight", d.settings.slideMargin), "vertical" == d.settings.mode && 0 < d.settings.slideMargin && d.children.css("marginBottom", d.settings.slideMargin), "fade" == d.settings.mode && (d.children.css({
          position: "absolute",
          zIndex: 0,
          display: "none"
          ...
          display: "block"
        })), d.controls.el = X('<div class="bx-controls" />'), d.settings.captions && T(), d.active.last = d.settings.startSlide == v() - 1, d.settings.video && c.fitVids();
        var t = d.children.eq(d.settings.startSlide);
        "all" == d.settings.preloadImages && (t = d.children), d.settings.ticker ? d.settings.pager = !1 : (d.settings.pager && S(), d.settings.controls && b(), d.settings.auto && d.settings.autoControls && w(), (d.settings.controls || d.settings.autoControls || d.settings.pager) && d.viewport.after(d.controls.el)), r(t, a);
      },
      r = function r(t, e) {
      ...
      p = function p() {
        ...
        if ("horizontal" == d.settings.mode && 0 < d.settings.slideWidth) {
          if (d.viewport.width() < d.minThreshold) t = d.settings.minSlides;else if (d.viewport.width() > d.maxThreshold) t = d.settings.maxSlides;else {
      ...
      v = function v() {
        ...
        if (0 < d.settings.moveSlides) {
          if (d.settings.infiniteLoop) t = Math.ceil(d.children.length / u());else for (var e = 0, i = 0; e < d.children.length;) ++t, e = i + p(), i += d.settings.moveSlides <= p() ? d.settings.moveSlides : p();
        ...
        if (d.children.length > d.settings.maxSlides && d.active.last && !d.settings.infiniteLoop) {
          if ("horizontal" == d.settings.mode) {
            var t = d.children.last(),
              e = t.position();
            x(-(e.left - (d.viewport.width() - t.outerWidth())), "reset", 0);
          ...
          e = d.children.eq(d.active.index * u()).position();
          d.active.index == v() - 1 && (d.active.last = !0), null != e && ("horizontal" == d.settings.mode ? x(-e.left, "reset", 0) : "vertical" == d.settings.mode && x(-e.top, "reset", 0));
        }
      },
      x = function x(t, e, i, s) {
        if (d.usingCSS) {
          ...
          c.css("-" + d.cssPrefix + "-transition-duration", i / 1e3 + "s"), "slide" == e ? (c.css(d.animProp, n), c.bind("transitionend webkitTransitionEnd oTransitionEnd MSTransitionEnd", function () {
            ...
            c.unbind("transitionend webkitTransitionEnd oTransitionEnd MSTransitionEnd"), x(s.resetValue, "reset", 0), W();
          }));
        } else {
          var o = {};
          o[d.animProp] = t, "slide" == e ? c.animate(o, i, d.settings.easing, function () {
            ...
            x(s.resetValue, "reset", 0), W();
          });
        }
      },
      m = function m() {
        for (var t = "", e = v(), i = 0; i < e; i++) {
          var s = "";
          d.settings.buildPager && X.isFunction(d.settings.buildPager) ? (s = d.settings.buildPager(i), d.pagerEl.addClass("bx-custom-pager")) : (s = i + 1, d.pagerEl.addClass("bx-default-pager")), t += '<div class="bx-pager-item"><a href="" data-slide-index="' + i + '" class="bx-pager-link">' + s + "</a></div>";
        }
        d.pagerEl.html(t);
      },
      S = function S() {
        d.settings.pagerCustom ? d.pagerEl = X(d.settings.pagerCustom) : (d.pagerEl = X('<div class="bx-pager" />'), d.settings.pagerSelector ? X(d.settings.pagerSelector).html(d.pagerEl) : d.controls.el.addClass("bx-has-pager").append(d.pagerEl), m()), d.pagerEl.on("click", "a", y);
      },
      b = function b() {
      ...
      k = function k() {
        if (d.settings.infiniteLoop) {
          var t = "";
          0 == d.active.index ? t = d.children.eq(0).position() : d.active.index == v() - 1 && d.carousel ? t = d.children.eq((v() - 1) * u()).position() : d.active.index == d.children.length - 1 && (t = d.children.eq(d.children.length - 1).position()), t && ("horizontal" == d.settings.mode ? x(-t.left, "reset", 0) : "vertical" == d.settings.mode && x(-t.top, "reset", 0));
        }
      ...
      q = function q() {
        1 == v() ? (d.controls.prev.addClass("disabled"), d.controls.next.addClass("disabled")) : !d.settings.infiniteLoop && d.settings.hideControlOnEnd && (0 == d.active.index ? (d.controls.prev.addClass("disabled"), d.controls.next.removeClass("disabled")) : d.active.index == v() - 1 ? (d.controls.next.addClass("disabled"), d.controls.prev.removeClass("disabled")) : (d.controls.prev.removeClass("disabled"), d.controls.next.removeClass("disabled")));
      },
      D = function D() {
        if (0 < d.settings.autoDelay) setTimeout(c.startAuto, d.settings.autoDelay);else c.startAuto();
      ...
      A = function A() {
        var t = 0;
        if ("next" == d.settings.autoDirection) c.append(d.children.clone().addClass("bx-clone"));else {
          c.prepend(d.children.clone().addClass("bx-clone"));
          var e = d.children.first().position();
          t = "horizontal" == d.settings.mode ? -e.left : -e.top;
        }
        x(t, "reset", 0), d.settings.pager = !1, d.settings.controls = !1, d.settings.autoControls = !1, d.settings.tickerHover && !d.usingCSS && d.viewport.hover(function () {
          c.stop();
        }, function () {
          var e = 0;
          d.children.each(function (t) {
      ...
      L = function L(t) {
        if (d.working) t.preventDefault();else {
      ...
      O = function O(t) {
        if (d.initialized) {
          var e = X(window).width(),
            i = X(window).height();
          s == e && n == i || (s = e, n = i, c.redrawSlider(), d.settings.onSliderResize.call(c, d.active.index));
        }
      };
    return c.goToSlide = function (t, e) {
      if (!d.working && d.active.index != t) if (d.working = !0, d.oldIndex = d.active.index, t < 0 ? d.active.index = v() - 1 : t >= v() ? d.active.index = 0 : d.active.index = t, d.settings.onSlideBefore(d.children.eq(d.active.index), d.oldIndex, d.active.index), "next" == e ? d.settings.onSlideNext(d.children.eq(d.active.index), d.oldIndex, d.active.index) : "prev" == e && d.settings.onSlidePrev(d.children.eq(d.active.index), d.oldIndex, d.active.index), d.active.last = d.active.index >= v() - 1, d.settings.pager && M(d.active.index), d.settings.controls && q(), "fade" == d.settings.mode) d.settings.adaptiveHeight && d.viewport.height() != g() && d.viewport.animate({
        height: g()
        ...
        if (!d.settings.infiniteLoop && d.carousel && d.active.last) {
          ...
          var o,
            r = 1 == d.settings.moveSlides ? d.settings.maxSlides - u() : (v() - 1) * u() - (d.children.length - d.settings.maxSlides);
          s = (o = c.children(".bx-clone").eq(r)).position();
        } else if ("next" == e && 0 == d.active.index) s = c.find("> .bx-clone").eq(d.settings.maxSlides).position(), d.active.last = !1;else if (0 <= t) {
          var a = t * u();
      ...
      d.children.add(c.find(".bx-clone")).width(h()), d.viewport.css("height", g()), d.settings.ticker || f(), d.active.last && (d.active.index = v() - 1), d.active.index >= v() && (d.active.last = !0), d.settings.pager && !d.settings.pagerCustom && (m(), M(d.active.index));
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["public/css/app"], () => (__webpack_require__("./assets/css/app.scss")))
